package br.com.organizacao.unittests.mapper;
...
import br.com.organizacao.unittests.mapper.mocks.MockPerson;
...
public class DozerConverterTest {
    ...
    public void parseEntityListToVOListTest() {
        List<PersonVO> outputList = DozzerMapper.parseListObject(inputObject.mockEntityList(), PersonVO.class);
    ...
    public void parserVOListToEntityListTest() {
        List<Person> outputList = DozzerMapper.parseListObject(inputObject.mockVOList(), Person.class);
